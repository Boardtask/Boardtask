...
pub fn routes() -> Router<AppState> {
    Router::new()
        ...
        .merge(crate::app::features::graph::get_task_statuses::routes())
        .merge(crate::app::features::graph::get_project_members::routes())
        .merge(crate::app::features::graph::slots::routes())
